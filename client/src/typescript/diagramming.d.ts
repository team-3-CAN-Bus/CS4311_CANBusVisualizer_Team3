...
declare module "Diagramming/Interaction/PointerInputDispatcher" {
    ...
    */
    export class PointerInputDispatcher {
        ...
        * @param {Point} position A point specified in diagram coordinates.
        */
        onPointerMove(position: Point, id: any): void;
        pointedItem: any;
        /**
        ...
        * @param {Number} button 0 for left button, 1 for middle button, 2 for right button.
        */
        onPointerUp(position: Point, button: number, id: any): void;
    ...
    */
    export class DiagramView extends CanvasControl {
        ...
        */
        ...
        _behavior: any;
        currentBehavior: LinkNodesBehavior | ModifyBehavior | DoNothingBehavior | DrawLinksBehavior | DrawNodesBehavior | PanBehavior | SelectOnlyBehavior | MagnifyBehavior | MoveNodesBehavior;
        /**
